...
export type AppAction =
  ...
  | { type: 'UPDATE_EVENT_ENTRY'; eventId: string; participantId: string; field: 'expected' | 'actual'; value: number }
  | { type: 'SPLIT_EQUALLY'; eventId: string; total: number }
  | { type: 'SET_SINGLE_PAYER'; eventId: string; payerId: string; total: number }
